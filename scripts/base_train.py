...
parser.add_argument("--rho", type=float, default=0.9, help="momentum for Affine-Scaled Attention alpha moving average")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, rho_momentum=args.rho,
    )
